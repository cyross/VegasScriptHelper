...
namespace VegasScriptHelper
{
    ...
    {
        public class DefaultList: Interfaces.IYamlSpec
        {
        ...
        public class DefaultColor : Interfaces.IYamlSpec
        {
        ...
        public class DefaultValue : Interfaces.IYamlSpec
        {
        ...
        public class SupportedAudioFile : DefaultList { }

        public class VoiceActorColors : DefaultColor { }

        public class VoiceActorOutlineColors : DefaultColor { }

        public class DefaultBinName : DefaultValue {
        ...
        public class DefaultTrackName : DefaultValue {
